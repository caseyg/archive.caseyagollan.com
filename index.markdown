...
- name: Reading
  url: http://reading.am/CaseyG
  start: 2012
  end: 
- name: Instagram
  url: http://instagram.com/caseygollan/
  start: 2011
  end: 
- name: Spotify
  url: https://open.spotify.com/user/sneezeburg
  start: 2011
  end: 
- name: Stellar
  url: http://stellar.io/caseyg
  start: 2011
  end: 
- name: Pinboard
  url: http://pinboard.in/u:caseygollan
  start: 2010
  end: 
- name: Github
...
- name: Twitter
  url: http://twitter.com/caseyg
  start: 2007
  end: 
- name: Facebook
  url: http://facebook.com/caseygollan
  start: 2005
  end: 
- name: Last.fm
  url: http://last.fm/user/caseygollan
  start: 2005
  end: 
- name: Tumblr
...
- name: Venmo
  url: https://venmo.com/Casey-Gollan
  start: 2014
  end: 
- name: Keybase
  url: https://keybase.io/caseyg
  start: 2014
  end: 
- name: Medium
  url: https://medium.com/@caseyg
  start: 2013
  end: 
- name: Soundcloud
  url: https://soundcloud.com/caseygollan
  start: 2013
  end: 
- name: Tinder
...
- name: Kindle
  url: https://kindle.amazon.com/profile/Casey-Gollan/1239626
  start: 2010
  end: 
- name: Hype Machine
...
- name: Mlkshk
  url: http://mlkshk.com/user/CaseyG
  start: 2012
  end: 
- name: Rhizome
  url: http://rhizome.org/profile/caseyg/
  start: 2012
  end: 
- name: Dribbble
  url: http://dribbble.com/CaseyG
  start: 2011
  end: 
- name: Metafilter
  url: http://www.metafilter.com/user/120538
  start: 2010
  end: 
- name: Flickr
  url: http://flickr.com/photos/caseygollan
  start: 2004
  end: 2014
- name: Neopets
  url: http://www.neopets.com/userlookup.phtml?user=silleywilley
  start: 2000
  end: 
- name: Youtube
...
- name: Instapaper
  url: https://www.instapaper.com/p/caseyisreading
  start: 2009
  end: 
- name: Pocket
  url: 
